...
class TransformerModel(nn.Module):
    def __init__(self, cfg):
        ...
        ##### USE a specific Pretrained Resnet
        # res50_model = models.resnet50(pretrained=False)
        # pretrained_weights = "/workspace/CARL_code/dataset/pretrained_models/BYOL_1000.pth"
        # state_dict = load_byol_pretrained(pretrained_weights)
        # res50_model.load_state_dict(state_dict, strict=False)
        #####        
    ...
    def forward(self, x, num_frames=None, video_masks=None, project=False, classification=False):
        ...
        # Since FRAMES_PER_BATCH=1000 and num_steps/NUM_FRAMES=240, num_blocks will always be 1, thus the following loop runs once
